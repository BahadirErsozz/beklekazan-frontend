  ...
  return (
    <>
      ...
      <div style={{ height: "300px",}}>
        <div style={{width: "auto", backgroundColor: "#034C8E", borderTopLeftRadius: "6px", borderTopRightRadius: "6px", padding: "10px"}}><div 
        onClick={() => {setClickedContactUs(false)}}
        style={{borderStyle: "",
        borderRadius: "50%",
      ...
      <div>+90 505 655 87 23</div>
      </div>
      
  </div >)}
        
        <div
        onClick={() => {setClickedContactUs(!clickedContactUs)}} 
        style={{width: "auto", textAlign: "center", cursor: "pointer", padding: "10px", borderTop: "1px solid rgb(220, 220, 220)"}}>
