...
const Navbar = () => {
    return (
        <>
        <div style={{width: "100%", height: "64px", display: "flex", position: "sticky", borderWidth: "10px:", boxShadow: "0 0.2rem 1rem rgb(0 0 0 / 12%)", top: "0px"}}>
            <div style={{display: "flex", alignItems: "center", width: "20%", justifyContent: "center"}}>
                <div style={{textAlign: "center", paddingLeft: "5px"}}>Şirket adı</div>
            </div>
